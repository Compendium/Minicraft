...
public class InstructionsMenu extends Menu {
	...
	public void render(Screen screen) {
		...
		Font.draw("with the left side", screen, 0 * 8 + 4, 4 * 8, Color.get(0, 333, 333, 333));
		Font.draw("of the touchscreen.", screen, 0 * 8 + 4, 5 * 8, Color.get(0, 333, 333, 333));
		Font.draw("Use the right-", screen, 0 * 8 + 4, 6 * 8, Color.get(0, 333, 333, 333));
		Font.draw("-lower side to attack", screen, 0 * 8 + 4, 7 * 8, Color.get(0, 333, 333, 333));
		Font.draw("-upper side to open", screen, 0 * 8 + 4, 8 * 8, Color.get(0, 333, 333, 333));
		Font.draw(" the Iventory/use Items.", screen, 0 * 8 + 4, 9 * 8, Color.get(0, 333, 333, 333));
